function doublesupport(nlp, bounds, varargin)
    % Extract Plant
    domain = nlp.Plant;
...
%     addNodeConstraint(nlp, cassie.constraints.step_width(nlp), ...
%         {'x'}, 'middle', bounds.toe_to_toe_outer_width.lb, bounds.toe_to_toe_outer_width.ub, 'Nonlinear');
%   
%     addNodeConstraint(nlp, cassie.constraints.step_width(nlp), ...
%         {'x'}, 'first', bounds.toe_to_toe_inner_width.lb, bounds.toe_to_toe_inner_width.ub, 'Nonlinear');
%     
%     addNodeConstraint(nlp, cassie.constraints.step_width(nlp), ...
%         {'x'}, 'last', bounds.toe_to_toe_inner_width.lb, bounds.toe_to_toe_inner_width.ub, 'Nonlinear');
