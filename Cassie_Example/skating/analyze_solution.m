...
[gait, sol, info] = skate.utils.load_result(nlp, file_name);
...
conGUI = cassie.load_animation(robot, gait, [], ...
    'SkipExporting', skip_export, ... % set 'SkipExporting' option to false for the first time to allow the code to generate functions used for animation
